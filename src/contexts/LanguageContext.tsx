...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'chat.assistantName': 'PLUSME Assistant (Groq AI)',
    'chat.greeting': "Hello! I'm PLUSME, powered by Groq's Llama 3.3 model. I can help you find suitable tasks and accommodations based on job roles and specific disabilities from our database. How can I assist you today?",
    'chat.you': 'You',
  ...
  sn: {
    ...
    'chat.assistantName': 'Mubatsiri wa PLUSME (Groq AI)',
    'chat.greeting': 'Mhoro! Ndiri PLUSME, ndinoshandiswa naGroq Llama 3.3 model. Ndinogona kukubatsira kuwana mabasa akakodzera uye kugarisana maererano nemabasa nezviremera kubva mudatabase yedu. Ndingakubatsira sei nhasi?',
    'chat.you': 'Iwe',
  ...
  nd: {
    ...
    'chat.assistantName': 'Umsizi we PLUSME (Groq AI)',
    'chat.greeting': 'Sawubona! NginguPLUSME, ngisebenza nge Groq Llama 3.3 model. Ngingakusiza ukuthola imisebenzi efaneleyo lokuhleleka mayelana lemisebenzi kanye lokukhubazeka ku database yethu. Ngingakusiza ngani lamuhla?',
    'chat.you': 'Wena',
  ...
  fr: {
    ...
    'chat.assistantName': 'Assistant PLUSME (Groq AI)',
    'chat.greeting': 'Bonjour! Je suis PLUSME, alimenté par le modèle Llama 3.3 de Groq. Je peux vous aider à trouver des tâches et des aménagements adaptés en fonction des rôles professionnels et des handicaps spécifiques. Comment puis-je vous aider aujourd\'hui?',
    'chat.you': 'Vous',
